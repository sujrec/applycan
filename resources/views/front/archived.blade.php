...
@section('title', 'Archived Applications | ApplyCan')
...
@section('content')
    <div class="tw:max-w-7xl tw:mx-auto tw:px-4 tw:py-8">
        ...
        {{-- Page Header --}}
        <div class="tw:mb-6">
            <h1 class="tw:text-xl tw:font-bold tw:text-slate-900">Archived applications</h1>
        </div>
            ...
            <form action="#" method="GET" class="tw:space-y-4">
                ...
                <div class="tw:grid tw:grid-cols-1 md:tw:grid-cols-4 tw:gap-4">
                    ...
                    <div class="tw:flex tw:gap-3">
                        ...
                        <button type="submit"
                            class="tw:bg-[#0056b3] tw:text-white tw:px-6 tw:py-2.5 tw:rounded-md tw:text-sm tw:font-bold hover:tw:bg-blue-800 tw:transition-colors">
                            Search
                        </button>
                    </div>
                </div>
                ...
                <table class="tw:w-full tw:text-left tw:border-collapse">
                    ...
                    <tbody class="tw:divide-y tw:divide-slate-100">
                        ...
                        <tr>
                            ...
                            <td class="tw:px-4 tw:py-6 tw:align-top">
                                <div class="tw:flex tw:flex-col tw:items-center tw:w-32">
                                    <img src="https://ui-avatars.com/api/?name=Puran+Chaulagain&background=random"
                                        class="tw:w-16 tw:h-16 tw:rounded tw:object-cover tw:mb-2" alt="Puran">
                                    <span class="tw:text-blue-600 tw:font-bold tw:text-sm tw:text-center">Puran
                                        Chaulagain</span>
                                </div>
                            </td>
                            <td class="tw:px-4 tw:py-6 tw:align-top">
                            ...
                            <td class="tw:px-4 tw:py-6 tw:align-top">
                                <div class="tw:flex tw:flex-col tw:gap-2">
                                    <span
                                        class="tw:bg-[#4ade80] tw:text-white tw:text-[11px] tw:px-3 tw:py-1 tw:rounded-full tw:font-medium tw:w-fit">Offer
                                        letter granted</span>
                                    <span
                                        class="tw:bg-[#4ade80] tw:text-white tw:text-[11px] tw:px-3 tw:py-1 tw:rounded-full tw:font-medium tw:w-fit">Ready
                                        for visa</span>
                                    <span
                                        class="tw:bg-[#f87171] tw:text-white tw:text-[11px] tw:px-3 tw:py-1 tw:rounded-full tw:font-medium tw:w-fit">Visa
                                        rejected</span>
                                </div>
                            </td>
                            <td class="tw:px-4 tw:py-6 tw:align-top tw:text-right">
                                <a href="#" class="tw:text-blue-600 tw:text-sm tw:font-medium hover:tw:underline">View
                                    application</a>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="tw:px-4 tw:py-6 tw:align-top">
                                <div class="tw:flex tw:flex-col tw:items-center tw:w-32">
                                    <img src="https://ui-avatars.com/api/?name=Sushan+Chand&background=random"
                                        class="tw:w-16 tw:h-16 tw:rounded tw:object-cover tw:mb-2" alt="Sushan">
                                    <span class="tw:text-blue-600 tw:font-bold tw:text-sm tw:text-center">Sushan
                                        Chand</span>
                                </div>
                            </td>
                            <td class="tw:px-4 tw:py-6 tw:align-top">
                            ...
                            <td class="tw:px-4 tw:py-6 tw:align-top tw:text-right">
                                <a href="#"
                                    class="tw:text-blue-600 tw:text-sm tw:font-medium hover:tw:underline">View
                                    application</a>
                            </td>
                        </tr>
                    </tbody>
